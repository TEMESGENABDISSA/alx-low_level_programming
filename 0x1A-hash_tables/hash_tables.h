 ...
 * @next: pointer to the next node  List
 */
 ...
 * @array:  array of size 
 * this array is a pointer to the first node of a linked-list,
 *  we want our Hash-Table to use a Chaining collision handling
 */
 ...
 * @array: array of size 
 *  this array is a pointer to the first node of a linked-list,
 * because w Hash-Table to use a Chaining collision handling
